...
var GOOGLE_URL = 'https://script.google.com/macros/s/AKfycbz1ixT3xemHEKwo8PPu6CYkO4-NAr4C1GNVvF9WSmnn240e5YHM/exec';
                        ...
                        function(e, params) {
                            ...
                            if (errorsFound.length) {
                                ...
                                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                                    ...
                                    $helpBlock.html("<ul class=\"alert alert-warning\" role=\"alert\"><li>" + errorsFound.join("</li><li>") + "</li></ul>" +
                                        (settings.options.prependExistingHelpBlock ? $helpBlock.data("original-contents") : ""));
                                }
                            } else {
